...
class Utils {
    ...
    public static void writeExtractedFileToDisk(InputStream in,  File oldDest, File newDest) throws IOException {

        OutputStream outs = new FileOutputStream(oldDest.getPath());
