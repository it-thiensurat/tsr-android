...
// Update status lead on line
    ...
    Call<Object> updates_status_leadonline(@Query("id") String idl, @Query("StatusWork") String statuswork, @Query("StatusCus") String statuscus, @Query("Namecustomer") String namecustomer, @Query("EmpSale") String empsale, @Query("IdProvince") String idprovince, @Query("Remark") String remark, @Query("SerialProduct") String serialproduct);
    /**test by tong**/
