...
public class UpdateDebtorCustomerInputInfo extends BHParcelable{
...
//	/*** [END] :: Fixed - [BHPROJ-0024-710] :: [ระบบงานขาย-บันทึกข้อมูลลูกค้าเพิ่มเติม] เพิ่มให้สามารถระบุ ชื่อ + เบอร์ติดต่อ บุคคลอ้างอิง ได้  ***/
	...
	public static UpdateDebtorCustomerInputInfo from(DebtorCustomerInfo dc) {
		UpdateDebtorCustomerInputInfo info = new UpdateDebtorCustomerInputInfo();
