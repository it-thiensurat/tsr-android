...
public class AddManualDocumentInputInfo extends BHParcelable {
	...
	public static  AddManualDocumentInputInfo from(ManualDocumentInfo localInfo) {
		AddManualDocumentInputInfo info = new AddManualDocumentInputInfo();
