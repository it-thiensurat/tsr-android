...
public class AddSpareDrawdownInputInfo extends BHParcelable {
    ...
    public static AddSpareDrawdownInputInfo from(SpareDrawdownInfo spareDrawdownInfo) {
        AddSpareDrawdownInputInfo info = new AddSpareDrawdownInputInfo();
        ...
        info.CreateDate = spareDrawdownInfo.CreateDate;
        info.CreateBy = spareDrawdownInfo.CreateBy;
