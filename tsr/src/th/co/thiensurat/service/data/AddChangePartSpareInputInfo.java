...
public class AddChangePartSpareInputInfo extends BHParcelable {
    ...
    public static AddChangePartSpareInputInfo from(ChangePartSpareInfo info) {
        AddChangePartSpareInputInfo wsInfo = new AddChangePartSpareInputInfo();
