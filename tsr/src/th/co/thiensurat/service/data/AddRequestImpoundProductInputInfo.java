...
public class AddRequestImpoundProductInputInfo extends BHParcelable {
...
//	public ImpoundProductInfo ImpoundProductInfo;
	...
	public static AddRequestImpoundProductInputInfo from(ImpoundProductInfo impoundProduct) {
		AddRequestImpoundProductInputInfo info = new AddRequestImpoundProductInputInfo();
