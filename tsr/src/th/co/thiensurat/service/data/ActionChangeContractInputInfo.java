...
public class ActionChangeContractInputInfo extends BHParcelable {
	...
	public static ActionChangeContractInputInfo from(ChangeContractInfo changeContract) {
		ActionChangeContractInputInfo info = new ActionChangeContractInputInfo();
