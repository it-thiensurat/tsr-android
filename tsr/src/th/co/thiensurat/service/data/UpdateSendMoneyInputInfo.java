...
public class UpdateSendMoneyInputInfo extends BHParcelable {
	...
	public static UpdateSendMoneyInputInfo from(SendMoneyInfo sm) {
		UpdateSendMoneyInputInfo info = new UpdateSendMoneyInputInfo();
