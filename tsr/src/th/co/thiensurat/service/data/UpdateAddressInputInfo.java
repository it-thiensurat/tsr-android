...
public class UpdateAddressInputInfo extends BHParcelable {
	...
	public static  UpdateAddressInputInfo from(AddressInfo address) {
		UpdateAddressInputInfo info = new UpdateAddressInputInfo();
