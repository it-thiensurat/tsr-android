...
public class AddSaleAuditInputInfo extends BHParcelable {
    ...
    public static AddSaleAuditInputInfo from(SaleAuditInfo sa) {
        AddSaleAuditInputInfo info = new AddSaleAuditInputInfo();
