...
public class AddRequestNextPaymentInputInfo extends BHParcelable {
    ...
    public static AddRequestNextPaymentInputInfo from(RequestNextPaymentInfo coc) {
        AddRequestNextPaymentInputInfo info = new AddRequestNextPaymentInputInfo();
