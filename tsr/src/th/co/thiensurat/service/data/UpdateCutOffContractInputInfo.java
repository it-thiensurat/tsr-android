...
public class UpdateCutOffContractInputInfo extends BHParcelable {
    ...
    public static UpdateCutOffContractInputInfo from(CutOffContractInfo coc) {
        UpdateCutOffContractInputInfo info = new UpdateCutOffContractInputInfo();
