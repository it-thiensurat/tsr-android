...
public class AddSalePaymentPeriodInputInfo extends BHParcelable {
	...
	public static AddSalePaymentPeriodInputInfo from(SalePaymentPeriodInfo spp) {
		AddSalePaymentPeriodInputInfo info = new AddSalePaymentPeriodInputInfo();
