...
public class AddRequestComplainInputInfo extends BHParcelable {
	...
	public static AddRequestComplainInputInfo from(ComplainInfo complain) {
		AddRequestComplainInputInfo info = new AddRequestComplainInputInfo();
