...
public class UpdateAssignInputInfo extends BHParcelable {
	...
	public static UpdateAssignInputInfo from(AssignInfo a) {
		UpdateAssignInputInfo info = new UpdateAssignInputInfo();
