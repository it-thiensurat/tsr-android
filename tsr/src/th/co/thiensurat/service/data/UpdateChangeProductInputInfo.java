...
public class UpdateChangeProductInputInfo extends BHParcelable {
	...
	public static UpdateChangeProductInputInfo from(ChangeProductInfo cp) {
		UpdateChangeProductInputInfo info = new UpdateChangeProductInputInfo();
