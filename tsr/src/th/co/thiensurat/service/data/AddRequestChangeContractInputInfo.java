...
public class AddRequestChangeContractInputInfo extends BHParcelable {
	...
	public static AddRequestChangeContractInputInfo from(ChangeContractInfo changeContract) {
		AddRequestChangeContractInputInfo info = new AddRequestChangeContractInputInfo();
		
		info.ChangeContractID = changeContract.ChangeContractID;
		info.OrganizationCode = changeContract.OrganizationCode;
		info.RefNo = changeContract.RefNo;
