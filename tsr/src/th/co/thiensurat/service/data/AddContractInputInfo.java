...
public class AddContractInputInfo extends BHParcelable {
    ...
    public String svcontno; // รหัสสัญญาสารกรอง (อาจจะเพิ่ม table
    // RelateContract)
    ...
    public static AddContractInputInfo from(ContractInfo contract) {
        AddContractInputInfo info = new AddContractInputInfo();
