...
public class UpdateSpareDrawdownDetailInputInfo extends BHParcelable {
    ...
    public static UpdateSpareDrawdownDetailInputInfo from(SpareDrawdownDetailInfo spareDrawdownDetailInfo) {
        UpdateSpareDrawdownDetailInputInfo info = new UpdateSpareDrawdownDetailInputInfo();
