...
public class AddRequestWriteOffNPLInputInfo extends BHParcelable {
	...
	public static AddRequestWriteOffNPLInputInfo from(WriteOffNPLInfo writeOffNPL) {
		AddRequestWriteOffNPLInputInfo info = new AddRequestWriteOffNPLInputInfo();
