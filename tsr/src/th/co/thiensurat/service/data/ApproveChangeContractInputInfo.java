...
public class ApproveChangeContractInputInfo extends BHParcelable {
	...
	public static ApproveChangeContractInputInfo from(ChangeContractInfo changeContract) {
		ApproveChangeContractInputInfo info = new ApproveChangeContractInputInfo();
