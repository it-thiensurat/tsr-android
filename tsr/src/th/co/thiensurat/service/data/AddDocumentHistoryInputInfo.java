...
public class AddDocumentHistoryInputInfo extends BHParcelable {
	...
	public static AddDocumentHistoryInputInfo from(DocumentHistoryInfo documentHistory) {
		AddDocumentHistoryInputInfo info = new AddDocumentHistoryInputInfo();
