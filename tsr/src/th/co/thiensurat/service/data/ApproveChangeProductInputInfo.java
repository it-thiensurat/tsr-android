...
public class ApproveChangeProductInputInfo extends BHParcelable {
	...
	public static ApproveChangeProductInputInfo from(ChangeProductInfo changeProduct) {
		ApproveChangeProductInputInfo info = new ApproveChangeProductInputInfo();
