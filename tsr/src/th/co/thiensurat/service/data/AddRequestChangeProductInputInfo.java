...
public class AddRequestChangeProductInputInfo extends BHParcelable {
	...
	public static AddRequestChangeProductInputInfo from(ChangeProductInfo changeProduct) {
		AddRequestChangeProductInputInfo info = new AddRequestChangeProductInputInfo();
		...
		//info.SyncedDate = changeProduct.SyncedDate;		
