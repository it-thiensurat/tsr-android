...
public class ApproveImpoundProductInputInfo extends BHParcelable {
...
//	public ImpoundProductInfo ImpoundProductInfo;
	...
	public static ApproveImpoundProductInputInfo from(ImpoundProductInfo impoundProduct) {
		ApproveImpoundProductInputInfo info = new ApproveImpoundProductInputInfo();
