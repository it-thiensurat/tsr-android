...
import th.co.thiensurat.fragments.sales.preorder.SaleConfirmBeforeReceiptFragment_preorder;
import th.co.thiensurat.fragments.sales.preorder.SalePhotographyFragment_preorder;


import th.co.thiensurat.views.ViewTitle;

public class SaleFirstPaymentChoiceFragment_preorder extends BHFragment {
    ...
    protected void onCreateViewSuccess(Bundle savedInstanceState) {
        ...
        if (data == null) {
            data = new SaleFirstPaymentChoiceFragment_preorder.Data();
        }
...
//        }
        ...
        final OnDateSetListener dpl = new OnDateSetListener() {
        ...
        if (isPostPone) {
            ...
            new BackgroundProcess(activity) {
                ...
                protected void calling() {
                    ...
                    SaleConfirmBeforeReceiptFragment_preorder.Data cbr = new SaleConfirmBeforeReceiptFragment_preorder.Data();
                    ...
                    cbr.receiptCode = TSRController.getAutoGenerateDocumentID(DocumentGenType.Receipt, BHPreference.SubTeamCode(), BHPreference.saleCode());
                ...
                cbr.contractCloseAccount = contractCloseAccount;*/
                    ...
                    SaleConfirmBeforeReceiptFragment_preorder fm = BHFragment.newInstance(SaleConfirmBeforeReceiptFragment_preorder.class, cbr);
                    showNextView(fm);
                }
    ...
    private void initialDateControlOfAppointmentsForPartlyPaid() {
        final OnDateSetListener dp2 = new OnDateSetListener() {
    ...
    private void bindCheckBox() {
        checkBoxPayment.setOnClickListener(new OnClickListener() {
            @Override
        ...
        checkBoxAppointments.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        checkBoxFullPaid.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        checkBoxPartlyPaid.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (checkBoxPartlyPaid.isChecked()) {
                    payPartial = true;
        ...
        checkBoxCash.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        checkBoxCredit.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        checkBoxCheque.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void saveAppointmentData() {
        new BackgroundProcess(activity) {
            ...
            @Override
            protected void calling() {
                postponeAppointment_preorder(data.processType, data.refNo, dtAppointmentDate, maxPaymentPeriodNumber, true);
            }
    ...
    private boolean validate() {
        ...
        if (checkBoxAppointments.isChecked()) {
            ...
            /*** [END] :: Fixed - [BHPROJ-1036-8595] - [LINE@17/09/2561] ทีม NBAH04 รหัสพนักงาน A55345 ส่วนที่รับชำระบางส่วนไม่ได้ ตามรูป  ***/
                ...
                switch (Enum.valueOf(SaleFirstPaymentChoiceFragment_preorder.ProcessType.class, BHPreference.ProcessType())) {
