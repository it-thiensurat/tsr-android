...
public class SaleListPackagePaymentFragment_preorder extends BHFragment {
	...
	public String fragmentTag() {
		...
		return SalePayFragment_preorder.FRAGMENT_SALE_PAY_TAG;
	}
	...
	private void updateContractDB() {
		...
		(new BackgroundProcess(activity) {
			...
			protected void after() {
				// TODO Auto-generated method stub
				showNextView(new SalePayFragment_preorder());
			}
		}).start();
	}
