...
import static th.co.thiensurat.data.controller.preorder.DocumentController_preorder.getAlbumStorageDir;
import static th.co.thiensurat.data.controller.preorder.DocumentController_preorder.getResizedBitmap;
import static th.co.thiensurat.retrofit.api.client.BASE_URL;

//import th.co.thiensurat.data.info.GET_data_payment_online;
//import th.co.thiensurat.retrofit.api.SQLiteHelper;

public class SaleContractPrintFragment_preorder extends BHFragment {
    ...
    @InjectView
    private TextView txt_name_sale;
    ...
    @InjectView
    private LinearLayout signature_layout,li_xx;
    @InjectView
            ...
            protected void after() {
                if (contract != null) {
                   ...
                   // txtContNo.setText(BHUtilities.trim(contract.CONTNO) + (contract.STATUS.equals("VOID") ? " (สัญญานี้ถูกยกเลิกแล้ว) " : ""));
                    ...
                    txtContNo.setText(BHUtilities.trim(BHApplication.getInstance().getPrefManager().getPreferrence("getContractReferenceNo")) + (contract.STATUS.equals("VOID") ? " (สัญญานี้ถูกยกเลิกแล้ว) " : ""));
                    ...
                    if (contract.MODE == 1) {
                        ...
                        txtCommitteeCash.setText(salename);
...
Log.e("bill","old");
                    ...
                    SaleReceiptPayment_old_preorder.Data input = new SaleReceiptPayment_old_preorder.Data();
                    input.resTitle = data.resTitle;
                    showNextView(BHFragment.newInstance(SaleReceiptPayment_old_preorder.class, input));
...
/*                    SaleReceiptPayment_old.Data input = new SaleReceiptPayment_old.Data();
                    ...
                    */
                       ...
                       // if(select_fragment==1){
                            SaleReceiptPayment_new_preorder.Data input = new SaleReceiptPayment_new_preorder.Data();
                            input.contno = BHUtilities.trim(contract.CONTNO);
                            showNextView(BHFragment.newInstance(SaleReceiptPayment_new_preorder.class, input));
                    /*    }
                        else {
...
//        new PrinterController(activity).printContract(contract, addressIDCard, addressInstall);
         ...
         * 07/08/2019
         */
        new PrinterController(activity).printNewImageContract_preorder(contract, addressIDCard, addressInstall);
        /**
         * End
         */
    }
