...
import th.co.thiensurat.fragments.sales.SaleFirstPaymentChoiceFragment.ProcessType;
import th.co.thiensurat.fragments.sales.SaleListPhotoFragment;
import th.co.thiensurat.fragments.sales.SaleMoreDetailAddress;
import th.co.thiensurat.fragments.sales.SalePhotographyMapFragment;

public class SalePhotographyFragment_preorder extends BHFragment {
...
//    @InjectView private ImageView imgGps;
    ...
    protected void onCreateViewSuccess(Bundle savedInstanceState) {
        ...
        FolderType F = FolderType.Picture;
        Parth = BHStorage.getFolder(F);
