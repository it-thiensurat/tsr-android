...
public class QuotationApproveFragment extends BHPagerFragment {
    ...
    protected void onCreateViewSuccess(Bundle savedInstanceState) {
        ...
        getQuotationApproveList();
    }

    private void getQuotationApproveList() {
        try {
            Call call = null;
            ...
            if (BHGeneral.SERVICE_MODE.toString() == "UAT") {
                ...
                call = request.getQuotationApproveUAT(BHPreference.employeeID());
            }
