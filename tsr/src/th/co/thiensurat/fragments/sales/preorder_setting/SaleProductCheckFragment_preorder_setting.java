...
public class SaleProductCheckFragment_preorder_setting extends BHFragment {
    ...
    protected int[] processButtons() {
        // TODO Auto-generated method stub
        return new int[] {
                R.string.button_back, R.string.button_save_emp
        };
    }
        ...
        (new BackgroundProcess(activity) {
            ...
            protected void calling() {
                ...
                if (contract == null) {
                    ...
                    //cont.RefNo = data.REFNO;
                    BHApplication.getInstance().getPrefManager().setPreferrence("REFNO_R2",cont.RefNo);
