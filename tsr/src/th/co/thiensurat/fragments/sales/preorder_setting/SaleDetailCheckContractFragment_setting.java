...
public class SaleDetailCheckContractFragment_setting extends BHFragment {
    ...
    @InjectView private TextView textViewModel;
    @InjectView
...
//                }
                ...
                data1.processType = SaleFirstPaymentChoiceFragment.ProcessType.Sale;
...
//    private void updateContractDB() {
    private void updateContractDB(final ManualDocumentInfo manualDoc) {
        ...
        (new BackgroundProcess(activity) {
            ...
            protected void after() {
                // TODO Auto-generated method stub
                SaleContractPrintFragment_setting fmSaleContractPrint = BHFragment.newInstance(SaleContractPrintFragment_setting.class);
                showNextView(fmSaleContractPrint);
            }
        }).start();
    }
