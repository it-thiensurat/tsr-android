...
public class SaleListPackagePaymentFragment_setting extends BHFragment {
	...
	private void GetMODE() {
		...
		(new BackgroundProcess(activity) {
			...
			MODE = getPackagePeriodDetail(BHPreference.organizationCode(), model);
				//MODE = getPackagePeriodDetail("0", model);
	...
	private void updateContractDB() {
		...
		(new BackgroundProcess(activity) {
			...
			protected void before() {
                ...
                Log.e("RefNo",BHPreference.RefNo());
				Log.e("saleprice", String.valueOf(saleprice));
				Log.e("model",model);
				Log.e("MODE", String.valueOf(MODE.size()));
			...
			protected void calling() {
				...
				Log.e("Contract.MODE ", String.valueOf(Contract.MODE));
			...
			protected void after() {
				// TODO Auto-generated method stub
				showNextView(new SalePayFragment_setting());
			}
		}).start();
	}
