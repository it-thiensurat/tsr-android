...
public class ReportSummaryCustomerProblemFirstFragment extends BHFragment {
	...
	protected int fragmentID() {
		...
		return R.layout.fragment_report_summary_customer_problem_first;
	}
	...
	private void loadData() {
		(new BackgroundProcess(activity) {
			...
			protected void calling() {
				// TODO Auto-generated method stub
				reportProblem = getReportProblem(YEAR, TEAM, PAYMENT);
			}
				...
				if (reportProblem != null) {
					adapter = new BHListViewAdapter(activity) {
						...
						protected int getItemCount(int section) {
							// TODO Auto-generated method stub
							return reportProblem != null ? reportProblem.size()
									: 0;
						}
					};
