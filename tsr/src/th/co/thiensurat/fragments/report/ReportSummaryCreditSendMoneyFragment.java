...
public class ReportSummaryCreditSendMoneyFragment extends BHFragment {

    @InjectView private WebView webView;

    @Override
    protected int titleID() {
        return R.string.menu_report_credit_sendmoney;
    }

    @Override
    protected int fragmentID() {
        return R.layout.fragment_report_summary_credit_sendmoney;
    }
...
//        return new int[]{R.string.button_back};
    ...
    private  void setWebView()
    {
        ...
        webView.loadUrl(BHPreference.TSR_REPORT_MOBILE + "?EmpID=" + BHPreference.employeeID() + "&Report=" + getResources().getString(R.string.mobile_report_credit_sendmoney) + "");
