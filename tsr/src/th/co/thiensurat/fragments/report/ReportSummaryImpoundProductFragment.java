...
public class ReportSummaryImpoundProductFragment extends BHFragment {
//	@InjectView
...
//
//	private List<ReportSummaryImpoundProductInfo> reportDataList;
//	private List<String> fortnightIDList = new ArrayList<String>();

	@Override
	protected int fragmentID() {
		// TODO Auto-generated method stub
		return R.layout.fragment_report_summary_impound_product;
	}
...
//		return new int[] { R.string.button_back };
	...
	private  void setWebView()
	{
		...
		webView.loadUrl(BHPreference.TSR_REPORT_MOBILE + "?EmpID=" + BHPreference.employeeID() + "&Report=" + getResources().getString(R.string.mobile_report_impound_product) + "");
	...
	private void getReportData(final String FortnightID) {
		...
		(new BackgroundProcess(activity) {
			...
			protected void calling() {
				...
				// "PAK-23");
				reportDataList = TSRController.getReportSummaryImpoundProduct(FortnightID, BHPreference.teamCode());
	...
	private void bindSummaryList() {
		...
		adapter = new BHListViewAdapter(activity) {
			class ViewHolder {
				public TextView txtImpoundProductDate;
			...
			protected int viewForSectionHeader(int section) {
				...
				return R.layout.list_report_summary_impound_product_header;
			...
			protected int viewForItem(int section, int row) {
				// TODO Auto-generated method stub
				return R.layout.list_report_summary_impound_product_item;
			}
			...
			protected void onViewItem(View view, Object holder, int section, int row) {
				...
				try {
					...
					vh.txtImpoundProductDate.setText(BHUtilities.dateFormat(reportDataList.get(row).ImpoundProductDate).toString());
