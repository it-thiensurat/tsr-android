...
public class ReportSummaryApprovedFragment extends BHFragment {
...
//
//	ReportSummaryRequestImpoundFragment ImpoundFragment = BHFragment
//			.newInstance(ReportSummaryRequestImpoundFragment.class);
//
//	ReportSummaryRequestNextPaymentFragment NextPaymentFragment = BHFragment
//			.newInstance(ReportSummaryRequestNextPaymentFragment.class);

	@Override
	protected int fragmentID() {
		// TODO Auto-generated method stub
		return R.layout.fragment_report_summary_approved;
	}

	@Override
	protected int titleID() {
		// TODO Auto-generated method stub
		return R.string.menu_report_approved;
	}
...
//		return new int[] { R.string.button_back };
	...
	private  void setWebView()
	{
		...
		webView.loadUrl(BHPreference.TSR_REPORT_MOBILE + "?EmpID=" + BHPreference.employeeID() + "&Report=" + getResources().getString(R.string.mobile_report_approved) + "");
	...
	private void setViewPager() {
		...
		try {
			...
			vpTotalMain.setAdapter(new FragmentPagerAdapter(
				...
				private final String[] PAGE_TITLE = { "ถอดเครื่อง", "เก็บงวดต่อไป" };
							...
							.setOnItemSelectedListener(new OnItemSelectedListener() {
								...
								public void onItemSelected(
									...
									if (!parent.getItemAtPosition(position)
										...
										ImpoundFragment.refreshData(year,
