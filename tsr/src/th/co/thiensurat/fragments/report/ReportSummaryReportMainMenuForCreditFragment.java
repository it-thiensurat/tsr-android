...
public class ReportSummaryReportMainMenuForCreditFragment extends BHFragment {
    ...
    private void selectedMenu(int position, int titleResourceID) {
        ...
        switch (titleResourceID) {
            ...
            case R.string.menu_report_daily_summary:            // รายงานสรุปยอดขาย - ReportDashboard (SALE)
                bhFragment= BHFragment.newInstance(ReportDailySummaryFragment.class);
    ...
    private void bindMenu() {
        final MenuInfo[] menus = MenuInfo.from(R.array.report_credit_menu);
