...
public class ReportRePrintDocumentFragment  extends BHFragment {
    ...
    protected int titleID() {
        return R.string.menu_report_re_print;
    }

    @Override
    protected int fragmentID() {
        return R.layout.fragment_report_re_print;
    }
...
//        return new int[]{R.string.button_back};
    ...
    private  void setWebView()
    {
        ...
        webView.loadUrl(BHPreference.TSR_REPORT_MOBILE + "?EmpID=" + BHPreference.employeeID() + "&Report=" + getResources().getString(R.string.mobile_report_re_print) + "");
