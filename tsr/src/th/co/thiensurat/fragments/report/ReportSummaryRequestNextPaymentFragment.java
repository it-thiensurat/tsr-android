...
public class ReportSummaryRequestNextPaymentFragment extends BHFragment {
	...
	protected int fragmentID() {
		...
		return R.layout.fragment_report_summary_request_nextpayment;
	}
	...
	private void loadData() {
		(new BackgroundProcess(activity) {
			...
			protected void calling() {
				// TODO Auto-generated method stub
				report = getReportRequest(YEAR, TEAM, NEXTPAYMENT);
			}
