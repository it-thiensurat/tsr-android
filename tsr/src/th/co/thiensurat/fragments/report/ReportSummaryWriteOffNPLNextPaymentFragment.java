...
public class ReportSummaryWriteOffNPLNextPaymentFragment extends BHFragment {
	...
	private final String WriteOffNPLType = "งวดต่อไป";
...
//				reportDataList = TSRController.getReportSummaryWriteOffNPL(ReportSummaryWriteOffNPLMainFragment.FortnightID, BHPreference.teamCode(),
//						WriteOffNPLType);
//
//			}
//
...
//				// TODO Auto-generated method stub
//
//				return R.layout.list_report_summary_write_off_npl_next_payment_header;
//
//			}
//
//			@Override
...
//				// TODO Auto-generated method stub
//				return R.layout.list_report_summary_write_off_npl_next_payment_item;
//			}
//
//			@Override
...
//					vh.txtWriteOffNPLDate.setText(BHUtilities.dateFormat(reportDataList.get(row).WriteOffNPLDate).toString());
//					vh.txtProductSerialNumber.setText(reportDataList.get(row).ProductSerialNumber);
//					vh.txtPaymentAmount.setText(String.valueOf(reportDataList.get(row).PaymentAmount));
//					vh.txtPaymentPeriod.setText(String.valueOf(reportDataList.get(row).PaymentPeriodNumber));
